        ...
        >
          <div className="flex flex-wrap items-start justify-between gap-8">
            <div>
              <div
                className={`mb-3 font-mono text-[10.5px] tracking-[.14em] ${
                  published ? 'text-gold-ink' : 'text-ink/75'
                }`}
              >
              ...
              <div className="text-ink/75 text-[14.5px]">
            ...
            <div className="border-ink/10 border-l pl-7 text-right">
              <div className="text-ink/75 mb-1.5 font-mono text-[10px] tracking-[.1em]">DURUM</div>
        ...
        {!published || !content ? (
          ...
          <>
            ...
            <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
              ...
              <div className="border-ink/10 border bg-white px-[26px] pt-[26px] pb-7">
                <div className="text-gold-ink mb-[18px] font-mono text-[10.5px] tracking-[.14em]">
                ...
                <div className="flex flex-col gap-[18px]">
                  {(content.improvements ?? []).map((s, i) => (
                    <div key={i} className="border-gold border-l-2 pl-[14px]">
                      ...
                      <div className="text-ink/75 text-[13.5px] leading-[1.62]">{s.what}</div>
            ...
            {(content.next_steps ?? []).length > 0 && (
              <div className="border-ink/10 mt-5 border bg-white px-8 py-6">
                <div className="text-ink/75 mb-3 font-mono text-[10.5px] tracking-[.14em]">
                  SONRAKİ ADIMLAR
                </div>
                <ul className="m-0 flex list-none flex-col gap-2 p-0">
                  {(content.next_steps ?? []).map((s, i) => (
                    <li key={i} className="text-ink/[.78] flex gap-2.5 text-[13.5px] leading-[1.6]">
                      <span className="text-gold-ink font-mono">{i + 1}.</span>
                      {s}
                    </li>
                  ))}
                </ul>
